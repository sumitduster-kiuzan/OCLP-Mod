...
class AboutFrame(wx.Frame):
    ...
    def _generate_elements(self, frame: wx.Frame) -> None:
        ...
        # Set title
        title = wx.StaticText(frame, label="Open Legacy Mode by laobamac", pos=(-1, 5))
        ...
        # Description
        description = [
            "A community-modified build of OpenCore Legacy Patcher",
            "Customized and localized by SimpleHac [laobamac]",
            "SimpleHac site: www.simplehac.cn",
            "QQ Group: 965625664",
        ]
        spacer = 5
