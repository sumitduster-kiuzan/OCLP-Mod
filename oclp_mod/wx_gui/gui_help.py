...
class HelpFrame(wx.Frame):
    ...
    def _generate_elements(self, frame: wx.Frame = None) -> None:
        ...
        title_label = wx.StaticText(frame, label="Open Legacy Mode Resources", pos=(-1,5))
        ...
        buttons = {
            ...
            "Official Discord": self.constants.discord_link,
            "SimpleHac Site": "https://www.simplehac.cn"
        }
